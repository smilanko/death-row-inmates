...
manuallyStoreInmateInfo <- function(execution_number, info_link, last_statement_link, last_name, first_name, tdjc_number, age_at_execution, execution_date, race, offense_county) {
	print(paste("storing found inmate", execution_number))
